...
function getLanguage(tag: string) {
	...
	if (typeof document !== 'undefined') {
		...
		//https://github.com/typescript-eslint/typescript-eslint/issues/7385
		//https://github.com/typescript-eslint/typescript-eslint/blob/main/packages/eslint-plugin/tests/rules/no-base-to-string.test.ts
		// eslint-disable-next-line @typescript-eslint/no-base-to-string
